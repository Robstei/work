	...
	#--  TRIALS --#
		...
		### INSTRUCTIONS ###
			...
			trial {    
				...
				picture {  
					...
					bitmap {filename = "instructions/original/play1.jpg";height=$inheight;width=$inwidth;};
					x = 0; y = 0;};
					sound sound1;
					time = 500;
			}inPlay1;
			...
			trial {    
				...
				picture {  
					# placeholder - set by PCL
					bitmap {filename = "instructions/original/play2.jpg";height=$inheight;width=$inwidth;};
					x = 0; y = 0;};
					sound sound2;
					time = 500;
			}inPlay2;
			...
			trial {    
				...
				picture {  
					# placeholder - set by PCL
					bitmap {filename = "instructions/original/play3.jpg";height=$inheight;width=$inwidth;};
					x = 0; y = 0;};
					sound sound3;
					time = 500;
			}inPlay3;
			...
			trial {    
				...
				picture {  
					# placeholder - set by PCL
					bitmap {filename = "instructions/original/play4.jpg";height=$inheight;width=$inwidth;};
					x = 0; y = 0;};
					sound sound4;
					time = 500;
			}inPlay4;		
		...
		#--  CORRECT ANSWER  --#
			trial {
				...
				stimulus_event{
					picture {
						box {color = 255,0,0; height = 400; width = 600;};
						x = 0; y = 0;
						box {color = 255,255,255; height = 380; width = 580;};
						x = 0; y = 0;};
					};
				}positiveFeedback; 
		#-- /CORRECT ANSWER  --#
		...
		#--  INCORRECT ANSWER  --#
			trial {
				...
				stimulus_event{
					picture {
						box {color = 0,255,0; height = 400; width = 600;};
						x = 0; y = 0;
						box {color = 255,255,255; height = 380; width = 580;};
						x = 0; y = 0;};
					};
